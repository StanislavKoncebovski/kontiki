...
class Kontiki:
    ...
    def query_books_by_tags(self, tags: str):
        '''
    ...
    def retrieve_book(self, md5: str, format: str = 'dict'):
        '''
        ...
        :return: The dictionary of the book's fields or its BibTeX reference, depending on the output format defined.
        '''
        pass
    ...
    def retrieve_article(self, doi: str, format: str = 'dict'):
        '''
        ...
        :return: The dictionary of the article's fields or its BibTeX reference, depending on the output format defined.
        '''
        pass